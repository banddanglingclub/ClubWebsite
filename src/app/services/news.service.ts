...
const ELEMENT_DATA: NewsItem[] = [
  ...
  {id: 2, date: new Date('2021-03-27'), title: 'Working Party', body: 'There will be a working party at <b>Roecliffe Lake</b> on <i>Saturday 27th March 2021 at 1pm</i>. Please come along and help keep the lake tidy and well equipped for fishing by all.'},
